...
const seedDatabase = async () => {
  try {
    ...
    const initialServices = [
      ...
      // 4. YouTube Comments (Cheapest Active Provider IDs - Random / Generic Comments)
      {
        ...
        description: 'Random positive relevant comments from active profiles (JAP ID 3458 - Provider Rate: $2.40 / ~₹198 per 1k).',
        providerId: provider3._id,
        providerServiceId: '3458',
      },
      {
        name: 'YouTube Comments [Standard - Generic Positive Comments]',
        category: 'YouTube Comments',
        ratePer1000: 5.00,
        minQuantity: 10,
        maxQuantity: 5000,
        ...
        description: 'Top Quality generic positive video comments (FineSMM ID 4172).',
        providerId: provider1._id,
        providerServiceId: '4172',
      },
      {
        name: 'YouTube Comments [Premium - VIP Random Positive Comments]',
        category: 'YouTube Comments',
        ratePer1000: 9.00,
        minQuantity: 10,
        maxQuantity: 5000,
        ...
        description: 'Ultra High Quality VIP random positive comments (FineSMM ID 4171).',
        providerId: provider1._id,
