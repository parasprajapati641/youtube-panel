...
const seedDatabase = async () => {
  try {
    ...
    const initialServices = [
      ...
      // 4. YouTube Comments (FineSMM Service IDs 4172 & 4171 with Server Auto-Generated Comments)
      {
        name: 'YouTube Comments [Wholesale Low-Cost | Random Positive Comments]',
        ...
        description: 'Top Quality random positive video comments (FineSMM ID 4172 - Rate: ₹365 / ~$4.45 per 1k).',
        providerId: provider1._id,
        providerServiceId: '4172',
      },
      {
        name: 'YouTube Comments [Standard - Indian Positive Comments | 30d Refill]',
        category: 'YouTube Comments',
        ratePer1000: 6.50,
        minQuantity: 10,
        maxQuantity: 5000,
        ...
        description: 'Top Quality Indian relevant positive comments with 30D Refill (FineSMM ID 4172 - Rate: ₹365 / ~$4.45 per 1k).',
        providerId: provider1._id,
        providerServiceId: '4172',
      },
      {
        name: 'YouTube Comments [Premium - USA Non-Drop Positive Comments]',
        category: 'YouTube Comments',
        ratePer1000: 9.50,
        minQuantity: 10,
        maxQuantity: 5000,
        ...
        description: 'Ultra High Quality USA non-drop positive comments (FineSMM ID 4171 - Rate: ₹685 / ~$8.35 per 1k).',
        providerId: provider1._id,
