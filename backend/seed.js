...
const seedDatabase = async () => {
  try {
    ...
    const initialServices = [
      ...
      // 4. YouTube Comments (Verified Text-Free Default Provider IDs)
      {
        name: 'YouTube Comments [Wholesale Low-Cost | AI Random Positive Comments]',
        category: 'YouTube Comments',
        ratePer1000: 7.50,
        minQuantity: 10,
        maxQuantity: 100000,
        status: 'active',
        speed: 'Speed: 10k/Day (Start: 0-1 Hour)',
        description: 'Global AI-generated positive video comments (JAP ID 9959 - Type: Default, No custom text required).',
        providerId: provider3._id,
        providerServiceId: '9959',
      },
      {
        name: 'YouTube Comments [Standard - USA AI Positive Comments | 30d Refill]',
        category: 'YouTube Comments',
        ratePer1000: 10.00,
        minQuantity: 10,
        maxQuantity: 100000,
        status: 'active',
        speed: 'Speed: 10k/Day (Start: 0-1 Hour)',
        description: 'USA targeted AI-generated positive comments with 30D refill guarantee (JAP ID 9960 - Type: Default, No custom text required).',
        providerId: provider3._id,
        providerServiceId: '9960',
      },
      {
        name: 'YouTube Comments [Premium - VIP USA AI Positive Comments]',
        category: 'YouTube Comments',
        ratePer1000: 18.00,
        minQuantity: 10,
        maxQuantity: 10000,
        status: 'active',
        speed: 'Speed: 10k/Day (Instant 0-15 Min Start)',
        description: 'High Quality VIP USA AI-generated positive comments (JAP ID 9961 - Type: Default, No custom text required).',
        providerId: provider3._id,
        providerServiceId: '9961',
      },
